...
def process_file(file_path, file_type):
    ...
    try:
        ...
        records_count = insert_into_db(formatted_data)
...
def process_zip_file(zip_path: str) -> Dict:
    ...
    from services.file_service import extract_zip_file, create_temp_directory, cleanup_temp_directory, get_supported_files_from_directory
